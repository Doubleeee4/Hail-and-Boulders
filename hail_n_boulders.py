...
class HailNBoulders:
    ...
    def roll_boing_spawn_chance(self):
        self.boing_delay -= 1
        if random.randint(1, self.boing_spawn_chance) == 2 and self.level_tracker > 5 and self.boing_delay < 0:
            self.boing_delay = 10
    ...
    def check_level_up_all(self):
        ...
        if level_up_flag:
            ...
            if self.level_tracker < 15:
                ...
                self.hail_spawn_chance = int(round(self.hail_spawn_chance * 0.93))
                ...
                self.boing_spawn_chance = self.boing_spawn_chance - 3
                self.boulder_speed += 2
                self.boing_speed += 2
                self.hail_speed += 2
            print(self.boulder_spawn_chance, self.boing_spawn_chance, self.hail_spawn_chance)
            level_up_flag = False
